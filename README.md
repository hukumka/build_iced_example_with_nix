...
1. Run `nix develop`, this will initilize the shell with all the required dependencies
```
nix develop 
```

2. Generate lock file. Result already in repo, so it is needed only then you will be recreating it in your project.
